...
var G__2940 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2940,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__2941__delegate = function (args){
...
while (G__2942__i < G__2942__a.length) {G__2942__a[G__2942__i] = arguments[G__2942__i + 0]; ++G__2942__i;}
  args = new cljs.core.IndexedSeq(G__2942__a,0,null);
} 
return G__2941__delegate.call(this,args);};
G__2941.cljs$lang$maxFixedArity = 0;
G__2941.cljs$lang$applyTo = (function (arglist__2943){
var args = cljs.core.seq(arglist__2943);
return G__2941__delegate(args);
});
...
var G__2944 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2944,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__2946__i = 0, G__2946__a = new Array(arguments.length -  0);
while (G__2946__i < G__2946__a.length) {G__2946__a[G__2946__i] = arguments[G__2946__i + 0]; ++G__2946__i;}
  args = new cljs.core.IndexedSeq(G__2946__a,0,null);
} 
return G__2945__delegate.call(this,args);};
G__2945.cljs$lang$maxFixedArity = 0;
G__2945.cljs$lang$applyTo = (function (arglist__2947){
var args = cljs.core.seq(arglist__2947);
return G__2945__delegate(args);
});
...
var G__2948 = props;
var G__2948__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2948,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2948);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2948__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__2949 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2949,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__2949;
}
})(),id_class);
...
var G__2950 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2950) {
case (0):
...
var vec__2952 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2952,(0),null);
var id = cljs.core.nth.call(null,vec__2952,(1),null);
var className = cljs.core.nth.call(null,vec__2952,(2),null);
...
var temp__5757__auto___2955 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___2955 == null)){
} else {
var key_2956 = temp__5757__auto___2955;
(jsprops.key = key_2956);
}
...
var temp__5757__auto___2957 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___2957 == null)){
} else {
var key_2958 = temp__5757__auto___2957;
(jsprops.key = key_2958);
}
...
var temp__5757__auto___2959 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___2959 == null)){
} else {
var key_2960 = temp__5757__auto___2959;
(jsprops.key = key_2960);
}
...
var temp__5757__auto___2961 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___2961 == null)){
} else {
var key_2962 = temp__5757__auto___2961;
(jsprops.key = key_2962);
}
...
var temp__5757__auto___2963 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___2963 == null)){
} else {
var key_2964 = temp__5757__auto___2963;
(jsprops.key = key_2964);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__2965_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__2965_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__2966 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__2966,(0),null);
var derefed = cljs.core.nth.call(null,vec__2966,(1),null);
...
break;
default:
var G__2971 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__2972 = compiler;
v = G__2971;
compiler = G__2972;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template2976 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template2976 = (function (opts,id,fn_to_element,meta2977){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta2977 = meta2977;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template2976.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_2978,meta2977__$1){
var self__ = this;
var _2978__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template2976(self__.opts,self__.id,self__.fn_to_element,meta2977__$1));
}));

(reagent.impl.template.t_reagent$impl$template2976.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_2978){
var self__ = this;
var _2978__$1 = this;
return self__.meta2977;
}));

(reagent.impl.template.t_reagent$impl$template2976.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template2976.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template2976.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template2976.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template2976.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta2977","meta2977",885232957,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template2976.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template2976.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template2976");

(reagent.impl.template.t_reagent$impl$template2976.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template2976");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template2976.
 */
reagent.impl.template.__GT_t_reagent$impl$template2976 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template2976(opts__$1,id__$1,fn_to_element__$1,meta2977){
return (new reagent.impl.template.t_reagent$impl$template2976(opts__$1,id__$1,fn_to_element__$1,meta2977));
});

}

return (new reagent.impl.template.t_reagent$impl$template2976(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1658996654896
