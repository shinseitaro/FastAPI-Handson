...
var G__27197 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__27197,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__27199__i < G__27199__a.length) {G__27199__a[G__27199__i] = arguments[G__27199__i + 0]; ++G__27199__i;}
  args = new cljs.core.IndexedSeq(G__27199__a,0,null);
} 
...
var G__27201 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__27201,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__27202__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__27202 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27203__i = 0, G__27203__a = new Array(arguments.length -  0);
while (G__27203__i < G__27203__a.length) {G__27203__a[G__27203__i] = arguments[G__27203__i + 0]; ++G__27203__i;}
  args = new cljs.core.IndexedSeq(G__27203__a,0,null);
} 
return G__27202__delegate.call(this,args);};
G__27202.cljs$lang$maxFixedArity = 0;
G__27202.cljs$lang$applyTo = (function (arglist__27204){
var args = cljs.core.seq(arglist__27204);
return G__27202__delegate(args);
});
...
var G__27205 = props;
var G__27205__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__27205,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27205);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27205__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__27206 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27206,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__27206;
}
})(),id_class);
...
var G__27207 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27207) {
case (0):
...
var vec__27209 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27209,(0),null);
var id = cljs.core.nth.call(null,vec__27209,(1),null);
var className = cljs.core.nth.call(null,vec__27209,(2),null);
...
var temp__5757__auto___27212 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___27212 == null)){
} else {
var key_27213 = temp__5757__auto___27212;
(jsprops.key = key_27213);
}
...
var temp__5757__auto___27214 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___27214 == null)){
} else {
var key_27215 = temp__5757__auto___27214;
(jsprops.key = key_27215);
}
...
var temp__5757__auto___27216 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___27216 == null)){
} else {
var key_27217 = temp__5757__auto___27216;
(jsprops.key = key_27217);
}
...
var temp__5757__auto___27218 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___27218 == null)){
} else {
var key_27219 = temp__5757__auto___27218;
(jsprops.key = key_27219);
}
...
var temp__5757__auto___27220 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___27220 == null)){
} else {
var key_27221 = temp__5757__auto___27220;
(jsprops.key = key_27221);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__27222_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__27222_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27223 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__27223,(0),null);
var derefed = cljs.core.nth.call(null,vec__27223,(1),null);
...
break;
default:
var G__27228 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__27229 = compiler;
v = G__27228;
compiler = G__27229;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27233 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27233 = (function (opts,id,fn_to_element,meta27234){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta27234 = meta27234;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template27233.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27235,meta27234__$1){
var self__ = this;
var _27235__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27233(self__.opts,self__.id,self__.fn_to_element,meta27234__$1));
}));

(reagent.impl.template.t_reagent$impl$template27233.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27235){
var self__ = this;
var _27235__$1 = this;
return self__.meta27234;
}));

(reagent.impl.template.t_reagent$impl$template27233.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27233.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27233.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27233.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27233.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta27234","meta27234",442866846,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27233.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27233.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27233");

(reagent.impl.template.t_reagent$impl$template27233.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template27233");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27233.
 */
reagent.impl.template.__GT_t_reagent$impl$template27233 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27233(opts__$1,id__$1,fn_to_element__$1,meta27234){
return (new reagent.impl.template.t_reagent$impl$template27233(opts__$1,id__$1,fn_to_element__$1,meta27234));
});

}

return (new reagent.impl.template.t_reagent$impl$template27233(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1658833863010
