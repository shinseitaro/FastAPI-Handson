...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_21147 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_21147.call(null,port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_21148 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_21148.call(null,port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_21149 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_21149.call(null,chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_21150 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_21150.call(null,chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_21151 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_21151.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_21152 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_21152.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_21153 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_21153.call(null,h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_21154 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_21154.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_21155 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_21155.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_21156 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_21156.call(null,b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_21157 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_21157.call(null,b);
}
});
...
//# sourceMappingURL=protocols.js.map?rel=1658997502394
