...
return cljs.core.reduce.call(null,(function (result,p__8575){
...
var vec__8579 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__8579,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__8579,(1),null);
var ab = cljs.core.nth.call(null,vec__8579,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_8585 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_8585.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_8586 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_8586.call(null,a,b);
}
});
...
return (function (){var G__8590 = clojure.data.equality_partition.call(null,a);
var G__8590__$1 = (((G__8590 instanceof cljs.core.Keyword))?G__8590.fqn:null);
switch (G__8590__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8590__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1658996659325
